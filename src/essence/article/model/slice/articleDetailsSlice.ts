...
const initialState: ArticleDetailsSchema = { data: null, error: null, isLoading: false }
...
const articleDetailsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchArticleByIdThunk.fulfilled, (state, action: PayloadAction<IArticle>) => {
      state.error = null
