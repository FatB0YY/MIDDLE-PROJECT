...
const sharedUiDirDirectory = project.getDirectory(uiPath)
const componentsDirs = sharedUiDirDirectory?.getDirectories()

function isAbsolute(value: string) {
  const layers = ['app', 'shared', 'features', 'essence', 'widgets', 'pages']
